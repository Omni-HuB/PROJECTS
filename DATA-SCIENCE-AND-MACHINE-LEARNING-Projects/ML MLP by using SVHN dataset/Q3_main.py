...
# def analyze_effectiveness(models):
#     # Analyze whether the model can learn effectively with all activation functions
#     # Examine the plotted curves and provide insights into the effectiveness of each activation function
#     pass

def evaluate_on_test_set(models, best_params, X_test, y_test):
    best_model = models[best_params['activation']]
    accuracy = best_model.score(X_test, y_test)
    print(f"Best Accuracy on Test Set: {accuracy}")

def visualize_misclassified_samples(X_test, y_test, best_model):
