...
const Home = () => {
  ...
  const getPosts = async () => {
    ...
    try {
      ...
      setPosts(Array.isArray(res) ? res : []); // ✅ Ensures `posts` is always an array
      setFilteredPosts(Array.isArray(res) ? res : []); // ✅ Ensures `filteredPosts` is always an array
      setLoading(false);
    } catch (error) {
      setError(error?.response?.data?.message || "Failed to load posts.");
      setFilteredPosts([]); // ✅ Avoid undefined errors
      setLoading(false);
    }
  };
